...
function errorFatal() {
  (error = new Audio("../sfx/G A M E O N.mp3")), error.play();
...
function setup() {
  $("#chat_send").click(sendInput),
    ...
    socket.on("admin", function () {
      admin = true;
      $(`#bonzi_` + this.id + `> .bonzi_user > .user-inner > .icon`).html(
        "<i class='fas fa-gavel' title='Administrator' style='color: #be6400'/>"
      );
    }),
  ...
  Bonzi = (function () {
    function a(b, c) {
      ...
      _classCallCheck(this, a),
        ...
        (this.selNameIcon =
          this.selElement + ".bonzi_user > .user-inner > .icon"),
                      ...
                      callback: function () {
                        socket.emit("talk", {
                          text:
                            "Hey, " +
                            d.userPublic.name +
                            "! You're the most retarded person ever.",
                        });
                      },
                    },
                    aaaaaab: {
      ...
      _createClass(a, [
          ...
          value: function () {
            if (allowCrossColors == true) {
              ...
              if (
                ...
                this.$canvas.css(
                  "background-image",
                  `url("${this.userPublic.color_cross}"), url("/img/hats/${this.hat}.png")`
                );
              } else {
                this.$canvas.css(
                  "background-image",
                  `url("/img/agents/${this.color}.png"), url("/img/hats/${this.hat}.png")`
                );
              }
            }
            if (
        ...
        },
        {
          ...
          value: function (a, b, c) {
            ...
            if (settings.notifications.value === true && LoggedIn === true) {
              try {
                new Notification("Room ID: " + Room_ID, {
                  body: date + " | " + this.userPublic.name + ": " + text,
                  icon:
                    "./img/agents/__closeup/" + this.userPublic.color + ".png",
                });
              } catch {}
            }
            var toscroll =
            ...
            if (this.userPublic.voice == "sam") {
              ...
              var voice2;
              this.userPublic.a = new Audio(
                "https://mespeakjs-server-production.up.railway.app/voiceforge?text=" +
                  encodeURIComponent(a) +
                  "&voice=" +
                  encodeURIComponent(
              ...
              var voice2;
              this.userPublic.a = new Audio(
                "https://api.streamelements.com/kappa/v2/speech?text=" +
                  encodeURIComponent(a) +
                  "&voice=" +
                  encodeURIComponent(
                    replaceAll(this.userPublic.voice, "streamelements:", "")
                  )
              );
              this.userPublic.a.play();
              this.userPublic.a.onended = function () {
        ...
        },
        {
          key: "updateName",
          value: function () {
            this.userPublic && this.userPublic.flags
              ? this.userPublic.flags &&
                this.userPublic.flags.admin &&
                this.$nameIcon.html(
                  "<i class='fas fa-gavel' title='Administrator' style='color: #be6400'/>"
                )
              : this.$nameIcon.html(""),
        ...
        },
        {
          ...
          value: function (a) {
            this.runSingleEvent([
              ...
              {
                type: "text",
                text: "Welcome to ReBonziWORLDivived!",
                say: "welcome to re bonziworld divived!",
              },
            ]);
          },
        },
